      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="today" className="space-y-4">
          <TabsList className="grid w-full grid-cols-4 h-auto">
            <TabsTrigger value="today" className="text-xs sm:text-sm p-2">আজকের টাস্ক</TabsTrigger>
          ...
          <TabsContent value="today" className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <h2 className="text-xl font-semibold">আজকের টাস্ক ({convertToBengaliNumber(getTodayTasks().length)})</h2>
              ...
              {getTodayTasks().length === 0 ? (
                <Card>
                  <CardContent className="p-8 text-center">
                    <p className="text-gray-500">আজকে কোন টাস্ক নেই</p>
                  </CardContent>
                </Card>
              ) : (
